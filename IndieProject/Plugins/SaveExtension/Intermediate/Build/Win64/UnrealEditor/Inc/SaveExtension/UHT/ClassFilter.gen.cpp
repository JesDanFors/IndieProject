...
template<> SAVEEXTENSION_API UScriptStruct* StaticStruct<FSEComponentClassFilter>()
{
	...
	struct Z_CompiledInDeferFile_FID_Forsbergsskola_Unreal_IndieProject_IndieProject_Plugins_SaveExtension_Source_SaveExtension_Public_Misc_ClassFilter_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Forsbergsskola_Unreal_IndieProject_IndieProject_Plugins_SaveExtension_Source_SaveExtension_Public_Misc_ClassFilter_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Forsbergsskola_Unreal_IndieProject_IndieProject_Plugins_SaveExtension_Source_SaveExtension_Public_Misc_ClassFilter_h_3607174480(TEXT("/Script/SaveExtension"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Forsbergsskola_Unreal_IndieProject_IndieProject_Plugins_SaveExtension_Source_SaveExtension_Public_Misc_ClassFilter_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Forsbergsskola_Unreal_IndieProject_IndieProject_Plugins_SaveExtension_Source_SaveExtension_Public_Misc_ClassFilter_h_Statics::ScriptStructInfo),
		nullptr, 0);
